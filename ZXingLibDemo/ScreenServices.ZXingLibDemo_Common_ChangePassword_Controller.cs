...
[Route("screenservices/ZXingLibDemo/Common/ChangePassword")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ZXingLibDemo_Common_ChangePassword_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ZXingLibDemo_Common_ChangePassword_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ZXingLibDemo_Common_ChangePassword_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ZXingLibDemo_Common_ChangePassword_Controller); }
        public override void EnsureInitialized() { ZXingLibDemo_Common_ChangePassword_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ZXingLibDemo_Common_ChangePassword_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController("ssOutSystemsUI.ScreenServices.OutSystemsUI_Controller", "OutSystemsUI", childControllers);
                ...
                Permissions.AddAsyncCheckPermissions(new ScreenName("Common.ChangePassword"), ZXingLibDemo_Common_ChangePassword_Controller.CheckPermissionsAsync);
            }
        }
    }
...
throw new Ex_NotZXingLibDemoRoleException( "ZXingLibDemo role required");
    ...
    static ZXingLibDemo_Common_ChangePassword_Controller() {
        Permissions = new CheckPermissionsIndex();
        Permissions.AddPermissionPropagationPath(/* Any Usage */CheckPermissionsIndex.ANY_USAGE_KEY, new String[] { CheckPermissionsIndex.ANY_USAGE_KEY, 
/*System_.ChangePassword*/"uXCIR2Atc0+es3zYuZSnNw*d1B7sWTlRUG2QJ_LNZy7Bw", 
/*Common.ChangePassword.SetIsButtonEnabled*/"eouRYZbkY0uZK7gymbIeQw*9iqkmKH9vU6ch9XH3uNckw", 
...
/*Common.OnException*/"eouRYZbkY0uZK7gymbIeQw*B4kRGvrnOEmQonA8ir4Pyg.#FlowExceptionHandler"});
    ...
    public ZXingLibDemo_Common_ChangePassword_Controller(
        IAppInfo appInfo,
...
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetUserDetail(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "cFGKfCwXRgiuqIx9mcaiKQ", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ZXingLibDemo_Common_ChangePassword_ScreenModel model = null;
...
try {model = RESTZXingLibDemo_Common_ChangePassword_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
long count;
(ds_output.List,count) = await ZXingLibDemo_Common_ChangePassword_ScreenModel.datasetGetUserDetail(requestContext,datasetGetUserDetail_maxRecords,datasetGetUserDetail_startIndex,IterationMultiplicity.Multiple,Convert.ToString(BuiltInFunction.GetUserId ()),cancellationToken);
