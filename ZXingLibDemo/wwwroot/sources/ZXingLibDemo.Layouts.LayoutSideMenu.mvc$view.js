...
import { Container as OSWidgets$Container, Link as OSWidgets$Link, AdvancedHtml as OSWidgets$AdvancedHtml, Placeholder as OSWidgets$Placeholder } from "@outsystems/runtime-widgets-js";
...
import ModelFactory from "./ZXingLibDemo.Layouts.LayoutSideMenu.mvc$model.js";
import ControllerFactory from "./ZXingLibDemo.Layouts.LayoutSideMenu.mvc$controller.js";
...
return ((((("layout layout-side" + ((model.variables.hasFixedHeaderIn) ? (" fixed-header") : (""))) + " ") + model.variables.menuBehaviorIn) + (((!(model.variables.enableAccessibilityFeaturesIn))) ? ("") : (" has-accessible-features"))) + (((model.variables.extendedClassIn === "")) ? ("") : ((" " + model.variables.extendedClassIn))));
}, function () {
...
style_dataFetchStatus: OS.Model.calculateDataFetchStatus(model.variables._hasFixedHeaderInDataFetchStatus, model.variables._menuBehaviorInDataFetchStatus, model.variables._enableAccessibilityFeaturesInDataFetchStatus, model.variables._extendedClassInDataFetchStatus)
}, createElement(OSWidgets$Link, {
enabled: true,
extendedProperties: {
"aria-label": "Skip to Content (Press Enter)",
"data-showskipcontent": model.getCachedValue(idService.getId("aHUxOLc9UUiFu0Mb9K10bA.data-showskipcontent"), function () {
...
_widgetRecordProvider: widgetsRecordProvider
}, "Skip to Content (Press Enter)"), createElement(OSWidgets$AdvancedHtml, {
extendedProperties: {
role: "complementary",
...
displayName: "Layouts.LayoutSideMenu",
