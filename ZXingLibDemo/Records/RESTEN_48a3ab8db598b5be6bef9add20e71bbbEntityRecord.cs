...
public static EN_48a3ab8db598b5be6bef9add20e71bbbEntityRecord ToStructure(ssZXingLibDemo.RestRecords.RESTEN_48a3ab8db598b5be6bef9add20e71bbbEntityRecord obj) { 
...
public static Func<EN_48a3ab8db598b5be6bef9add20e71bbbEntityRecord, ssZXingLibDemo.RestRecords.RESTEN_48a3ab8db598b5be6bef9add20e71bbbEntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (EN_48a3ab8db598b5be6bef9add20e71bbbEntityRecord s) => FromStructure(s, config);
}
public static ssZXingLibDemo.RestRecords.RESTEN_48a3ab8db598b5be6bef9add20e71bbbEntityRecord FromStructure(EN_48a3ab8db598b5be6bef9add20e71bbbEntityRecord s, IBehaviorsConfiguration config) { 
  return new ssZXingLibDemo.RestRecords.RESTEN_48a3ab8db598b5be6bef9add20e71bbbEntityRecord(s, config);
}
