...
public ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_59c2aa6a35b14343cc78f655810f9ce8Structure AttrLocalization;
...
public ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_30625b4ad0f3e10abf82b61ea58e8644Structure AttrMarkerClusterer;
...
AttrLocalization = ConvertToRestWithoutDefaults(s.ssLocalization, new ST_59c2aa6a35b14343cc78f655810f9ce8Structure(), ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_59c2aa6a35b14343cc78f655810f9ce8Structure.FromStructureDelegate(config));
AttrMapStyleId = ConvertToRestWithoutDefaults(s.ssMapStyleId, "");
AttrMarkerClusterer = ConvertToRestWithoutDefaults(s.ssMarkerClusterer, new ST_30625b4ad0f3e10abf82b61ea58e8644Structure(), ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_30625b4ad0f3e10abf82b61ea58e8644Structure.FromStructureDelegate(config));
AttrOffset = ConvertToRestWithoutDefaults(s.ssOffset, new ST_be62cc31fbe4705834275960beeb55e2Structure(), ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_be62cc31fbe4705834275960beeb55e2Structure.FromStructureDelegate(config));
...
AttrLocalization = ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_59c2aa6a35b14343cc78f655810f9ce8Structure.FromStructure(s.ssLocalization, config);
AttrMapStyleId = s.ssMapStyleId;
AttrMarkerClusterer = ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_30625b4ad0f3e10abf82b61ea58e8644Structure.FromStructure(s.ssMarkerClusterer, config);
AttrOffset = ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_be62cc31fbe4705834275960beeb55e2Structure.FromStructure(s.ssOffset, config);
...
public static Func<ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_d609eacb476c603df8b92eb374da99faStructure, ST_d609eacb476c603df8b92eb374da99faStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_d609eacb476c603df8b92eb374da99faStructure s) => ToStructure(s, config);
}
public static ST_d609eacb476c603df8b92eb374da99faStructure ToStructure(ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_d609eacb476c603df8b92eb374da99faStructure obj, IBehaviorsConfiguration config) { 
  ...
  s.ssLocalization = ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_59c2aa6a35b14343cc78f655810f9ce8Structure.ToStructure(obj.AttrLocalization, config);
  s.ssMapStyleId = obj.AttrMapStyleId == null ? "" : obj.AttrMapStyleId;
  s.ssMarkerClusterer = ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_30625b4ad0f3e10abf82b61ea58e8644Structure.ToStructure(obj.AttrMarkerClusterer, config);
  s.ssOffset = ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_be62cc31fbe4705834275960beeb55e2Structure.ToStructure(obj.AttrOffset, config);
...
public static Func<ST_d609eacb476c603df8b92eb374da99faStructure, ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_d609eacb476c603df8b92eb374da99faStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_d609eacb476c603df8b92eb374da99faStructure s) => FromStructure(s, config);
}
public static ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_d609eacb476c603df8b92eb374da99faStructure FromStructure(ST_d609eacb476c603df8b92eb374da99faStructure s, IBehaviorsConfiguration config) { 
  return new ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_d609eacb476c603df8b92eb374da99faStructure(s, config);
}
