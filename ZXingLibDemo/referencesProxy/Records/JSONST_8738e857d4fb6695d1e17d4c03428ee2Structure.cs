...
public static Func<ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_8738e857d4fb6695d1e17d4c03428ee2Structure, ST_8738e857d4fb6695d1e17d4c03428ee2Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_8738e857d4fb6695d1e17d4c03428ee2Structure s) => ToStructure(s, config);
}
public static ST_8738e857d4fb6695d1e17d4c03428ee2Structure ToStructure(ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_8738e857d4fb6695d1e17d4c03428ee2Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_8738e857d4fb6695d1e17d4c03428ee2Structure, ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_8738e857d4fb6695d1e17d4c03428ee2Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_8738e857d4fb6695d1e17d4c03428ee2Structure s) => FromStructure(s, config);
}
public static ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_8738e857d4fb6695d1e17d4c03428ee2Structure FromStructure(ST_8738e857d4fb6695d1e17d4c03428ee2Structure s, IBehaviorsConfiguration config) { 
  return new ssZXingLibDemo.ReferencesProxy.RestRecords.JSONST_8738e857d4fb6695d1e17d4c03428ee2Structure(s, config);
}
