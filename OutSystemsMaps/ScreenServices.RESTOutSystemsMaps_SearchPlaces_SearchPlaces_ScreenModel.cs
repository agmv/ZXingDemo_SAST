...
public class RESTOutSystemsMaps_SearchPlaces_SearchPlaces_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTOutSystemsMaps_SearchPlaces_SearchPlaces_DataActionGetApiVersion_Outputs varLcGetApiVersion;
[JsonProperty("GetServerAPIKey")]
public RESTOutSystemsMaps_SearchPlaces_SearchPlaces_DataActionGetServerAPIKey_Outputs varLcGetServerAPIKey;
...
public ScreenModelVariables variables = new ScreenModelVariables();
    ...
    public static RESTOutSystemsMaps_SearchPlaces_SearchPlaces_ScreenModel FromJSON(JObject screenModel, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTOutSystemsMaps_SearchPlaces_SearchPlaces_ScreenModel result = screenModel.ToObject<RESTOutSystemsMaps_SearchPlaces_SearchPlaces_ScreenModel>(settings);
return result;
}


    public OutSystemsMaps_SearchPlaces_SearchPlaces_ScreenModel ToModel() {string inParamAPIKey = variables.inParamAPIKey == null ? "" : variables.inParamAPIKey;
...
OutSystemsMaps_SearchPlaces_SearchPlaces_DataActionGetApiVersion_Model _varLcGetApiVersion = (variables.varLcGetApiVersion != null) ? RESTOutSystemsMaps_SearchPlaces_SearchPlaces_DataActionGetApiVersion_Outputs.ToModel(variables.varLcGetApiVersion) : null;
OutSystemsMaps_SearchPlaces_SearchPlaces_DataActionGetServerAPIKey_Model _varLcGetServerAPIKey = (variables.varLcGetServerAPIKey != null) ? RESTOutSystemsMaps_SearchPlaces_SearchPlaces_DataActionGetServerAPIKey_Outputs.ToModel(variables.varLcGetServerAPIKey) : null;
OutSystemsMaps_SearchPlaces_SearchPlaces_ScreenModel screenModel = new OutSystemsMaps_SearchPlaces_SearchPlaces_ScreenModel(inParamAPIKey, inParamOptionalConfigs, varLcUniqueId, varLcIsSecondRound, varLcInternal_Configs, varLcSearchAreaString, varLcSearchArea, varLcCountriesString, _varLcGetApiVersion, _varLcGetServerAPIKey);
return screenModel;
}
