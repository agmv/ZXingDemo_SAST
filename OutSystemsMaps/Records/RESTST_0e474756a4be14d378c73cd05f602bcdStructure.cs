...
public static ST_0e474756a4be14d378c73cd05f602bcdStructure ToStructure(ssOutSystemsMaps.RestRecords.RESTST_0e474756a4be14d378c73cd05f602bcdStructure obj) { 
...
public static Func<ST_0e474756a4be14d378c73cd05f602bcdStructure, ssOutSystemsMaps.RestRecords.RESTST_0e474756a4be14d378c73cd05f602bcdStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_0e474756a4be14d378c73cd05f602bcdStructure s) => FromStructure(s, config);
}
public static ssOutSystemsMaps.RestRecords.RESTST_0e474756a4be14d378c73cd05f602bcdStructure FromStructure(ST_0e474756a4be14d378c73cd05f602bcdStructure s, IBehaviorsConfiguration config) { 
  return new ssOutSystemsMaps.RestRecords.RESTST_0e474756a4be14d378c73cd05f602bcdStructure(s, config);
}
