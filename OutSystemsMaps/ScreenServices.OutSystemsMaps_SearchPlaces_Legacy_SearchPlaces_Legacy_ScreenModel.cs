...
public class OutSystemsMaps_SearchPlaces_Legacy_SearchPlaces_Legacy_ScreenModel : VarsBag {

    private static readonly ActivitySource activitySource = new(typeof(OutSystemsMaps_SearchPlaces_Legacy_SearchPlaces_Legacy_ScreenModel).Namespace);
...
public OutSystemsMaps_SearchPlaces_Legacy_SearchPlaces_Legacy_DataActionGetApiVersion_Model varLcGetApiVersion;
public OutSystemsMaps_SearchPlaces_Legacy_SearchPlaces_Legacy_DataActionGetServerAPIKey_Model varLcGetServerAPIKey;


    public OutSystemsMaps_SearchPlaces_Legacy_SearchPlaces_Legacy_ScreenModel() {
}



    public OutSystemsMaps_SearchPlaces_Legacy_SearchPlaces_Legacy_ScreenModel(string inParamAPIKey, ST_7cd861eaa819851d6fba6d8150ed8cc1Structure inParamOptionalConfigs, string varLcUniqueId, bool varLcIsSecondRound, ST_b0933bf7957301c22e5d9229ad792ac0Structure varLcInternal_Configs, string varLcSearchAreaString, ST_31cb630f5fdaa3aa4d3dbfd37cbf9e56Structure varLcSearchArea, string varLcCountriesString, OutSystemsMaps_SearchPlaces_Legacy_SearchPlaces_Legacy_DataActionGetApiVersion_Model varLcGetApiVersion, OutSystemsMaps_SearchPlaces_Legacy_SearchPlaces_Legacy_DataActionGetServerAPIKey_Model varLcGetServerAPIKey) {
...
using (activitySource.CreateScreenDataActionActivity("SearchPlaces_Legacy", "GetApiVersion")){
...
try {
cancellationToken.ThrowIfCancellationRequested();
using (activitySource.CreateScreenDataActionActivity("SearchPlaces_Legacy", "GetServerAPIKey")){
