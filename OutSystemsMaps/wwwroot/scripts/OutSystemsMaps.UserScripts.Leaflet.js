...
!(function (t, e) {
    ...
    function Me(t) {
        ...
        t.style &&
            (ze(), (le = (he = t).style.outlineStyle), (t.style.outlineStyle = 'none'), S(window, 'keydown', ze));
    }
    function ze() {
    ...
    function $e(t, e) {
        ...
        for (
            var l = w([0, 0]),
                u = g(t),
                c =
                    (u.getNorthWest().distanceTo(u.getSouthWest()) * u.getNorthEast().distanceTo(u.getNorthWest()) <
                        1700 && (l = Qe(t)),
                    t.length),
                d = [],
                _ = 0;
    ...
    function hi(t, e) {
        ...
        for (
            var h = w([0, 0]),
                l = g(t),
                u =
                    (l.getNorthWest().distanceTo(l.getSouthWest()) * l.getNorthEast().distanceTo(l.getNorthWest()) <
                        1700 && (h = Qe(t)),
                    t.length),
                c = [],
                d = 0;
