...
import OutSystemsMaps_Shape_Events_ShapeEvent_mvc_controller_OnReady_GetActionsHandlerJS from "./OutSystemsMaps.Shape_Events.ShapeEvent.mvc$controller.OnReady.GetActionsHandlerJS.js";
...
span.setAttribute("outsystems.function.key", "49711935-bab0-4bb7-b607-357ad5224c72");
...
// Execute Action: ShapeEventTriggeredUnsubscribe
OutSystemsMapsController.default.shapeEventTriggeredUnsubscribe$Action(model.variables.uniqueIdVar, model.variables.eventNameIn, model.variables.callbackVar, callContext);
} finally {
if(span) {
span.end();
}
...
span.setAttribute("outsystems.function.key", "bb08201a-195f-4240-b131-b9dd3ee4e7c1");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "0638bf9f-2ef9-45e8-86fb-6139775f6a92");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "JAVASCRIPT");
}

try {return controller.safeExecuteJSNode(OutSystemsMaps_Shape_Events_ShapeEvent_mvc_controller_OnReady_GetActionsHandlerJS, "GetActionsHandler", "OnReady", {
CallbackEvent: OS.DataConversion.JSNodeParamConverter.to(null, OS.DataTypes.DataTypes.Object)
}, function ($parameters) {
var jsNodeResult = new (controller.constructor.getVariableGroupType("OutSystemsMaps.Shape_Events.ShapeEvent.OnReady$getActionsHandlerJSResult"))();
...
// Execute Action: ShapeEventTriggeredSubscribe
OutSystemsMapsController.default.shapeEventTriggeredSubscribe$Action(model.variables.uniqueIdVar, model.variables.eventNameIn, model.variables.callbackVar, callContext);
} finally {
if(span) {
span.end();
}
...
span.setAttribute("outsystems.function.key", "d0379c6b-4317-45a1-9896-fa20e814cd74");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
this.__callback_Event$Action = function (mapIdIn, shapeIdIn, evtNameIn, callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
...
span.setAttribute("outsystems.function.key", "f5d31717-acee-4d62-a493-2ea78d42e0fa");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("OutSystemsMaps.Shape_Events.ShapeEvent.Callback_Event$vars"))());
vars.value.mapIdInLocal = mapIdIn;
vars.value.shapeIdInLocal = shapeIdIn;
vars.value.evtNameInLocal = evtNameIn;
return OS.Flow.executeAsyncFlow(function () {
// Trigger Event: Action
return controller.action$Action(vars.value.mapIdInLocal, vars.value.shapeIdInLocal, vars.value.evtNameInLocal, callContext);
});
}, function () {
if(span) {
span.end();
...
callback_Event$Action(mapIdIn, shapeIdIn, evtNameIn, callContext) {
var controller = this.controller;
...
return OS.Flow.tryFinally(function () {
return controller.safeExecuteClientAction(controller._callback_Event$Action, callContext, mapIdIn, shapeIdIn, evtNameIn);
}, function () {
if(span) {
span.end();
}
...
Controller.registerVariableGroupType("OutSystemsMaps.Shape_Events.ShapeEvent.OnReady$getActionsHandlerJSResult", [{
name: "CallbackEvent",
...
Controller.registerVariableGroupType("OutSystemsMaps.Shape_Events.ShapeEvent.Callback_Event$vars", [{
name: "MapId",
