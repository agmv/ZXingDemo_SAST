...
import OutSystemsMaps_Drawing_Tools_DrawCircle_mvc_controller_SubscribeEvents_GetCallbackHandlerJS from "./OutSystemsMaps.Drawing_Tools.DrawCircle.mvc$controller.SubscribeEvents.GetCallbackHandlerJS.js";
import OutSystemsMaps_Drawing_Tools_DrawCircle_mvc_controller_OnDestroy_GetCallbackHandlerJS from "./OutSystemsMaps.Drawing_Tools.DrawCircle.mvc$controller.OnDestroy.GetCallbackHandlerJS.js";
...
span.setAttribute("outsystems.function.key", "358a4234-e464-42f1-88e9-42d36cf2d424");
...
span.setAttribute("outsystems.function.key", "38b805d4-4498-4fe1-8523-8555d129c99e");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "JAVASCRIPT");
}

try {return controller.safeExecuteJSNode(OutSystemsMaps_Drawing_Tools_DrawCircle_mvc_controller_SubscribeEvents_GetCallbackHandlerJS, "GetCallbackHandler", "SubscribeEvents", {
OnCircleCreated_Callback: OS.DataConversion.JSNodeParamConverter.to(null, OS.DataTypes.DataTypes.Object)
}, function ($parameters) {
var jsNodeResult = new (controller.constructor.getVariableGroupType("OutSystemsMaps.Drawing_Tools.DrawCircle.SubscribeEvents$getCallbackHandlerJSResult"))();
jsNodeResult.onCircleCreated_CallbackOut = OS.DataConversion.JSNodeParamConverter.from($parameters.OnCircleCreated_Callback, OS.DataTypes.DataTypes.Object);
return jsNodeResult;
}, {
...
OutSystemsMapsController.default.toolsEventSubscribe$Action(model.variables.uniqueIdVar, OutSystemsMapsModel.staticEntities.drawingToolsEventTriggered.circleCreated, getCallbackHandlerJSResult.value.onCircleCreated_CallbackOut, callContext);
} finally {
if(span) {
span.end();
}
...
span.setAttribute("outsystems.function.key", "4b771e7a-bf33-4589-8c83-54920bf7c21a");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "5a10eea9-9325-4065-bceb-0b5a452b5ce1");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
if(span) {
span.setAttribute("code.function", "GetCallbackHandler");
span.setAttribute("outsystems.function.key", "a2fc42c6-8c11-4012-b7bc-0a8a79cf73c5");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "JAVASCRIPT");
}

try {return controller.safeExecuteJSNode(OutSystemsMaps_Drawing_Tools_DrawCircle_mvc_controller_OnDestroy_GetCallbackHandlerJS, "GetCallbackHandler", "OnDestroy", {
OnCircleCreated_Callback: OS.DataConversion.JSNodeParamConverter.to(null, OS.DataTypes.DataTypes.Object)
}, function ($parameters) {
var jsNodeResult = new (controller.constructor.getVariableGroupType("OutSystemsMaps.Drawing_Tools.DrawCircle.OnDestroy$getCallbackHandlerJSResult"))();
jsNodeResult.onCircleCreated_CallbackOut = OS.DataConversion.JSNodeParamConverter.from($parameters.OnCircleCreated_Callback, OS.DataTypes.DataTypes.Object);
return jsNodeResult;
}, {
Callback_Event: controller.clientActionProxies.callback_Event$Action
...
OutSystemsMapsController.default.toolsEventUnSubscribe$Action(model.variables.uniqueIdVar, OutSystemsMapsModel.staticEntities.drawingToolsEventTriggered.circleCreated, getCallbackHandlerJSResult.value.onCircleCreated_CallbackOut, callContext);
...
span.setAttribute("outsystems.function.key", "6fe64a78-ad27-4bcb-9d92-f61bd86a1828");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
this.__callback_Event$Action = function (mapWidgetIdIn, circleIdIn, isNewCircleIn, coordinatesIn, locationIn, callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
...
span.setAttribute("outsystems.function.key", "769fc7d8-d6dc-4a1c-99fc-2e38922fff93");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("OutSystemsMaps.Drawing_Tools.DrawCircle.Callback_Event$vars"))());
vars.value.mapWidgetIdInLocal = mapWidgetIdIn;
vars.value.circleIdInLocal = circleIdIn;
vars.value.isNewCircleInLocal = isNewCircleIn;
vars.value.coordinatesInLocal = coordinatesIn;
vars.value.locationInLocal = locationIn;
var jSONDeserializeCircleShapeVar = new OS.DataTypes.VariableHolder(new (OS.Controller.BaseController.getJSONDeserializeOutputType(OutSystemsMapsModel.ST_b3f640c8758c66e2b436da510a8dfe3cStructure))());
...
// JSON Deserialize: JSONDeserializeCircleShape
jSONDeserializeCircleShapeVar.value.dataOut = OS.JSONUtils.deserializeFromJSON(vars.value.locationInLocal, OutSystemsMapsModel.ST_b3f640c8758c66e2b436da510a8dfe3cStructure, false);
// Trigger Event: OnDrawingChange
return controller.onDrawingChange$Action(vars.value.mapWidgetIdInLocal, vars.value.circleIdInLocal, vars.value.isNewCircleInLocal, jSONDeserializeCoordinatesVar.value.dataOut, jSONDeserializeCircleShapeVar.value.dataOut.locationAttr, OS.BuiltinFunctions.decimalToInteger(OS.BuiltinFunctions.trunc(jSONDeserializeCircleShapeVar.value.dataOut.radiusAttr)), callContext);
});
}, function () {
if(span) {
span.end();
...
span.setAttribute("outsystems.function.key", "88cc0e2e-01a7-46c2-a8a9-f9d5822d514c");
span.setAttribute("outsystems.function.owner.name", "OutSystemsMaps");
span.setAttribute("outsystems.function.owner.key", "95bb31d1-f079-4fd6-ab2e-5c8326855aaa");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
OutSystemsMapsController.default.addTool$Action(model.variables.uniqueIdVar, OutSystemsMapsModel.staticEntities.drawingToolType.circle, serialize_ConfigsVar.value.jSONOut, callContext);
...
callback_Event$Action(mapWidgetIdIn, circleIdIn, isNewCircleIn, coordinatesIn, locationIn, callContext) {
var controller = this.controller;
...
return OS.Flow.tryFinally(function () {
return controller.safeExecuteClientAction(controller._callback_Event$Action, callContext, mapWidgetIdIn, circleIdIn, isNewCircleIn, coordinatesIn, locationIn);
}, function () {
if(span) {
span.end();
}
...
Controller.registerVariableGroupType("OutSystemsMaps.Drawing_Tools.DrawCircle.SubscribeEvents$getCallbackHandlerJSResult", [{
name: "OnCircleCreated_Callback",
attrName: "onCircleCreated_CallbackOut",
mandatory: true,
...
Controller.registerVariableGroupType("OutSystemsMaps.Drawing_Tools.DrawCircle.OnDestroy$getCallbackHandlerJSResult", [{
name: "OnCircleCreated_Callback",
attrName: "onCircleCreated_CallbackOut",
mandatory: true,
dataType: OS.DataTypes.DataTypes.Object,
...
Controller.registerVariableGroupType("OutSystemsMaps.Drawing_Tools.DrawCircle.Callback_Event$vars", [{
name: "MapWidgetId",
