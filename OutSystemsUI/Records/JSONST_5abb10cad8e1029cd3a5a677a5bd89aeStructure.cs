...
public class JSONST_5abb10cad8e1029cd3a5a677a5bd89aeStructure : AbstractRESTStructure<ST_5abb10cad8e1029cd3a5a677a5bd89aeStructure> {
...
[JsonPropertyName("StartingValueFrom")]
public decimal? AttrStartingValueFrom;

[JsonProperty("StartingValueTo")]
[JsonPropertyName("StartingValueTo")]
...
[JsonPropertyName("InitialValueFrom")]
public decimal? AttrInitialValueFrom;

[JsonProperty("InitialValueTo")]
[JsonPropertyName("InitialValueTo")]
public decimal? AttrInitialValueTo;

public JSONST_5abb10cad8e1029cd3a5a677a5bd89aeStructure() { }

public JSONST_5abb10cad8e1029cd3a5a677a5bd89aeStructure (ST_5abb10cad8e1029cd3a5a677a5bd89aeStructure s, IBehaviorsConfiguration config) {
...
public static Func<ssOutSystemsUI.RestRecords.JSONST_5abb10cad8e1029cd3a5a677a5bd89aeStructure, ST_5abb10cad8e1029cd3a5a677a5bd89aeStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssOutSystemsUI.RestRecords.JSONST_5abb10cad8e1029cd3a5a677a5bd89aeStructure s) => ToStructure(s, config);
}
public static ST_5abb10cad8e1029cd3a5a677a5bd89aeStructure ToStructure(ssOutSystemsUI.RestRecords.JSONST_5abb10cad8e1029cd3a5a677a5bd89aeStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_5abb10cad8e1029cd3a5a677a5bd89aeStructure, ssOutSystemsUI.RestRecords.JSONST_5abb10cad8e1029cd3a5a677a5bd89aeStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_5abb10cad8e1029cd3a5a677a5bd89aeStructure s) => FromStructure(s, config);
}
public static ssOutSystemsUI.RestRecords.JSONST_5abb10cad8e1029cd3a5a677a5bd89aeStructure FromStructure(ST_5abb10cad8e1029cd3a5a677a5bd89aeStructure s, IBehaviorsConfiguration config) { 
  return new ssOutSystemsUI.RestRecords.JSONST_5abb10cad8e1029cd3a5a677a5bd89aeStructure(s, config);
}
