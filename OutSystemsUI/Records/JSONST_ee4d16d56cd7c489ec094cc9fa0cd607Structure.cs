...
[JsonPropertyName("autoSelectFirstOption")]
...
[JsonPropertyName("moreText")]
public string AttrmoreText;

[JsonProperty("noOfDisplayValues")]
[JsonPropertyName("noOfDisplayValues")]
...
[JsonPropertyName("showDropboxAsPopup")]
public string AttrshowDropboxAsPopup;

[JsonProperty("showOptionsOnlyOnSearch")]
[JsonPropertyName("showOptionsOnlyOnSearch")]
...
[JsonPropertyName("showSelectedOptionsFirst")]
...
public JSONST_ee4d16d56cd7c489ec094cc9fa0cd607Structure() { }

public JSONST_ee4d16d56cd7c489ec094cc9fa0cd607Structure (ST_ee4d16d56cd7c489ec094cc9fa0cd607Structure s, IBehaviorsConfiguration config) {
...
AttrdisabledOptions = s.ssdisabledOptions.Length == 0 ? null : s.ssdisabledOptions.ToArray();
...
AttrdisabledOptions = s.ssdisabledOptions.ToArray();
...
public static Func<ssOutSystemsUI.RestRecords.JSONST_ee4d16d56cd7c489ec094cc9fa0cd607Structure, ST_ee4d16d56cd7c489ec094cc9fa0cd607Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssOutSystemsUI.RestRecords.JSONST_ee4d16d56cd7c489ec094cc9fa0cd607Structure s) => ToStructure(s, config);
}
public static ST_ee4d16d56cd7c489ec094cc9fa0cd607Structure ToStructure(ssOutSystemsUI.RestRecords.JSONST_ee4d16d56cd7c489ec094cc9fa0cd607Structure obj, IBehaviorsConfiguration config) { 
  ...
  s.ssdisabledOptions = BasicTypeList<string>.ToList(obj.AttrdisabledOptions);
...
public static Func<ST_ee4d16d56cd7c489ec094cc9fa0cd607Structure, ssOutSystemsUI.RestRecords.JSONST_ee4d16d56cd7c489ec094cc9fa0cd607Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_ee4d16d56cd7c489ec094cc9fa0cd607Structure s) => FromStructure(s, config);
}
public static ssOutSystemsUI.RestRecords.JSONST_ee4d16d56cd7c489ec094cc9fa0cd607Structure FromStructure(ST_ee4d16d56cd7c489ec094cc9fa0cd607Structure s, IBehaviorsConfiguration config) { 
  return new ssOutSystemsUI.RestRecords.JSONST_ee4d16d56cd7c489ec094cc9fa0cd607Structure(s, config);
}
