...
// We'll also sanitize both labels and values to reduce XSS vulnerabilities
for(var i = 0; i < paramList.length; i++) {
    itemList.push({value:Sanitize(paramList[i].Value), label: Sanitize(paramList[i].Text)});
}
