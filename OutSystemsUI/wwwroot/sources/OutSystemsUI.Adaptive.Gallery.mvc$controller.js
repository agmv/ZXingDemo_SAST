...
import OutSystemsUI_Adaptive_Gallery_mvc_TranslationsResources from "./OutSystemsUI.Adaptive.Gallery.mvc$translationsResources.js";
import OutSystemsUI_Adaptive_Gallery_mvc_controller_RegisterCallbacks_GetCallbackHandlersJS from "./OutSystemsUI.Adaptive.Gallery.mvc$controller.RegisterCallbacks.GetCallbackHandlersJS.js";

var OS = OSRuntimeCore;
{class ControllerInner extends 
OS.Controller.BaseViewController {
constructor(model, messagesProvider, idService) {
super(model, messagesProvider, idService, OutSystemsUI_Adaptive_Gallery_mvc_TranslationsResources);
var controller = this.controller;
this.clientActionProxies = {
initializedHandler$Action: function (galleryIdIn) {
galleryIdIn = (galleryIdIn === undefined) ? "" : galleryIdIn;
return controller.executeActionInsideJSNode(controller._initializedHandler$Action.bind(controller, OS.DataConversion.JSNodeParamConverter.from(galleryIdIn, OS.DataTypes.DataTypes.Text)), controller.callContext(), function (actionResults) {
return {};
}, function () {
return;
}, "InitializedHandler");
...
span.setAttribute("outsystems.function.key", "5459d23f-0390-4502-84fa-01a15f551924");
...
span.setAttribute("outsystems.function.key", "993aa900-c093-4af7-9b2f-047e319926a0");
span.setAttribute("outsystems.function.owner.name", "OutSystemsUI");
span.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "9a476224-82c4-4d0f-9d2f-18e89e77161b");
span.setAttribute("outsystems.function.owner.name", "OutSystemsUI");
span.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
// Execute Action: Update_RowItemsPhone
OutSystemsUIController.default.galleryChangeTextProperty$Action(model.variables.internal_configsVar.uniqueIdAttr, "RowItemsPhone", model.variables.internal_configsVar.rowItemsPhoneAttr, callContext);
}
...
// Execute Action: Update_RowItemsTablet
OutSystemsUIController.default.galleryChangeTextProperty$Action(model.variables.internal_configsVar.uniqueIdAttr, "RowItemsTablet", model.variables.internal_configsVar.rowItemsTabletAttr, callContext);
}
...
// Execute Action: Update_RowItemsDesktop
OutSystemsUIController.default.galleryChangeTextProperty$Action(model.variables.internal_configsVar.uniqueIdAttr, "RowItemsDesktop", model.variables.internal_configsVar.rowItemsDesktopAttr, callContext);
}
...
// Execute Action: Update_ItemsGap
OutSystemsUIController.default.galleryChangeTextProperty$Action(model.variables.internal_configsVar.uniqueIdAttr, "ItemsGap", model.variables.internal_configsVar.itemsGapAttr, callContext);
}
...
OutSystemsUIController.default.galleryChangeTextProperty$Action(model.variables.internal_configsVar.uniqueIdAttr, "ExtendedClass", model.variables.internal_configsVar.extendedClassAttr, callContext);
}
...
this.__initializedHandler$Action = function (galleryIdIn, callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
...
span.setAttribute("outsystems.function.key", "bc44f04e-d3a6-4da3-ac29-f9f7800c0b3b");
span.setAttribute("outsystems.function.owner.name", "OutSystemsUI");
span.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("OutSystemsUI.Adaptive.Gallery.InitializedHandler$vars"))());
vars.value.galleryIdInLocal = galleryIdIn;
return OS.Flow.executeAsyncFlow(function () {
// Trigger Event: Initialized
return controller.initialized$Action(vars.value.galleryIdInLocal, callContext);
});
}, function () {
if(span) {
span.end();
...
span.setAttribute("outsystems.function.key", "e6191de5-d11f-4bd9-b0a1-80a8af1cec45");
span.setAttribute("outsystems.function.owner.name", "OutSystemsUI");
span.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "a250a322-bea6-44b5-b40d-212a6964f1fa");
span.setAttribute("outsystems.function.owner.name", "OutSystemsUI");
span.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271");
span.setAttribute("outsystems.function.type", "JAVASCRIPT");
}

try {return controller.safeExecuteJSNode(OutSystemsUI_Adaptive_Gallery_mvc_controller_RegisterCallbacks_GetCallbackHandlersJS, "GetCallbackHandlers", "RegisterCallbacks", {
Initialized: OS.DataConversion.JSNodeParamConverter.to(null, OS.DataTypes.DataTypes.Object)
}, function ($parameters) {
var jsNodeResult = new (controller.constructor.getVariableGroupType("OutSystemsUI.Adaptive.Gallery.RegisterCallbacks$getCallbackHandlersJSResult"))();
...
OutSystemsUIController.default.galleryRegisterCallback$Action(model.variables.internal_configsVar.uniqueIdAttr, OutSystemsUIModel.staticEntities.registeredCallbackEvents.initialized, getCallbackHandlersJSResult.value.initializedOut, callContext);
} finally {
if(span) {
span.end();
}
...
span.setAttribute("outsystems.function.key", "f590b1c8-2ce5-4213-b875-6ab4cbaf666d");
span.setAttribute("outsystems.function.owner.name", "OutSystemsUI");
span.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
initializedHandler$Action(galleryIdIn, callContext) {
var controller = this.controller;
...
return OS.Flow.tryFinally(function () {
return controller.safeExecuteClientAction(controller._initializedHandler$Action, callContext, galleryIdIn);
}, function () {
if(span) {
span.end();
}
...
Controller.registerVariableGroupType("OutSystemsUI.Adaptive.Gallery.InitializedHandler$vars", [{
name: "GalleryId",
...
Controller.registerVariableGroupType("OutSystemsUI.Adaptive.Gallery.RegisterCallbacks$getCallbackHandlersJSResult", [{
name: "Initialized",
