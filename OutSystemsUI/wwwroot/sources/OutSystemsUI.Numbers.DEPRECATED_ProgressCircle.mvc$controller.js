...
import OutSystemsUI_Numbers_DEPRECATED_ProgressCircle_mvc_TranslationsResources from "./OutSystemsUI.Numbers.DEPRECATED_ProgressCircle.mvc$translationsResources.js";
import OutSystemsUI_Numbers_DEPRECATED_ProgressCircle_mvc_controller_OnReady_InitCircleJS from "./OutSystemsUI.Numbers.DEPRECATED_ProgressCircle.mvc$controller.OnReady.InitCircleJS.js";
import OutSystemsUI_Numbers_DEPRECATED_ProgressCircle_mvc_controller_OnParametersChanged_UpdateProgressJS from "./OutSystemsUI.Numbers.DEPRECATED_ProgressCircle.mvc$controller.OnParametersChanged.UpdateProgressJS.js";

var OS = OSRuntimeCore;
{class ControllerInner extends 
OS.Controller.BaseViewController {
constructor(model, messagesProvider, idService) {
super(model, messagesProvider, idService, OutSystemsUI_Numbers_DEPRECATED_ProgressCircle_mvc_TranslationsResources);
...
span.setAttribute("outsystems.function.key", "aac55c79-feb3-4def-aab2-e6aa87124f6e");
...
span.setAttribute("outsystems.function.key", "63888ff5-dc55-45f7-99ea-5cff3ca3d1a3");
span.setAttribute("outsystems.function.owner.name", "OutSystemsUI");
span.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271");
span.setAttribute("outsystems.function.type", "JAVASCRIPT");
}

try {return controller.safeExecuteJSNode(OutSystemsUI_Numbers_DEPRECATED_ProgressCircle_mvc_controller_OnReady_InitCircleJS, "InitCircle", "OnReady", {
Progress: OS.DataConversion.JSNodeParamConverter.to(model.variables.progressIn, OS.DataTypes.DataTypes.Integer),
StrokeWidth: OS.DataConversion.JSNodeParamConverter.to(model.variables.circleThicknessIn, OS.DataTypes.DataTypes.Integer),
Text: OS.DataConversion.JSNodeParamConverter.to((((model.variables.textIn === "-")) ? (((model.variables.progressIn).toString() + "%")) : (model.variables.textIn)), OS.DataTypes.DataTypes.Text),
SecondaryColorHex: OS.DataConversion.JSNodeParamConverter.to(model.variables.trailColorIn, OS.DataTypes.DataTypes.Text),
PrimaryColorHex: OS.DataConversion.JSNodeParamConverter.to(model.variables.progressColorIn, OS.DataTypes.DataTypes.Text),
...
TextColor: OS.DataConversion.JSNodeParamConverter.to(model.variables.textColorIn, OS.DataTypes.DataTypes.Text),
...
var jsNodeResult = new (controller.constructor.getVariableGroupType("OutSystemsUI.Numbers.DEPRECATED_ProgressCircle.OnReady$initCircleJSResult"))();
...
span.setAttribute("outsystems.function.key", "ee0dcfe1-2650-40cc-b690-8b42c5d366b8");
span.setAttribute("outsystems.function.owner.name", "OutSystemsUI");
span.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "39dfffd3-7a0e-4f56-a4ae-e3f8087ff164");
span.setAttribute("outsystems.function.owner.name", "OutSystemsUI");
span.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271");
span.setAttribute("outsystems.function.type", "JAVASCRIPT");
}

try {return controller.safeExecuteJSNode(OutSystemsUI_Numbers_DEPRECATED_ProgressCircle_mvc_controller_OnParametersChanged_UpdateProgressJS, "UpdateProgress", "OnParametersChanged", {
Text: OS.DataConversion.JSNodeParamConverter.to((((model.variables.textIn === "-")) ? (((model.variables.progressIn).toString() + "%")) : (model.variables.textIn)), OS.DataTypes.DataTypes.Text),
Progress: OS.DataConversion.JSNodeParamConverter.to(model.variables.progressIn, OS.DataTypes.DataTypes.Integer),
...
Controller.registerVariableGroupType("OutSystemsUI.Numbers.DEPRECATED_ProgressCircle.OnReady$initCircleJSResult", [{
name: "CircleObject",
