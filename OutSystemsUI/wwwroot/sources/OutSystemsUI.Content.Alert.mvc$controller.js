...
import OutSystemsUI_Content_Alert_mvc_TranslationsResources from "./OutSystemsUI.Content.Alert.mvc$translationsResources.js";
...
get _focusAlert$Action() {if(!(this.hasOwnProperty("__focusAlert$Action"))) {
...
try {controller.ensureControllerAlive("FocusAlert");
...
}set _focusAlert$Action(value) {this.__focusAlert$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._focusAlert$Action, callContext);
} finally {
if(span) {
span.end();
}
