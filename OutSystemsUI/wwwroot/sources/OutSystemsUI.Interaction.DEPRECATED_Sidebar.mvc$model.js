...
this.attr("MoveX", "moveXVar", "MoveX", true, false, OS.DataTypes.DataTypes.Decimal, function () {
return OS.DataTypes.Decimal.defaultValue;
}, false), 
...
this.attr("SidebarWidth", "sidebarWidthVar", "SidebarWidth", true, false, OS.DataTypes.DataTypes.Integer, function () {
return 280;
}, false), 
this.attr("RenderBar", "renderBarVar", "RenderBar", true, false, OS.DataTypes.DataTypes.Boolean, function () {
return false;
}, false), 
...
this.attr("IsSidebarList", "isSidebarListVar", "IsSidebarList", true, false, OS.DataTypes.DataTypes.Boolean, function () {
return false;
}, false), 
