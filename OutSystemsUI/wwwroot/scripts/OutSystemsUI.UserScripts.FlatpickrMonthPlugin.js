    ...
    function monthSelectPlugin(pluginConfig) {
        ...
        return function (fp) {
            ...
            function bindEvents() {
                ...
                function onEventCallback(e, isNext) {
                    e.preventDefault();
                    e.stopPropagation();
                    var targetYear = isNext ? fp.currentYear + 1 : fp.currentYear - 1;
                    var focusTarget = isNext ? fp.nextMonthNav : fp.prevMonthNav;
                ...
                fp._bind(fp.prevMonthNav, "keydown", function (e) {
                    // If Space or Enter
                    if (e.keyCode === 13 || e.keyCode === 32) {
                        onEventCallback(e, false);
                    }
                });
                fp._bind(fp.nextMonthNav, "keydown", function (e) {
                    // If Space or Enter
                    if (e.keyCode === 13 || e.keyCode === 32) {
                        onEventCallback(e, true);
                    }
                ...
                var yearInputParent = fp.yearElements[0].parentElement, yearNavArrowUp = yearInputParent.querySelector(".arrowUp"), yearNavArrowDown = yearInputParent.querySelector(".arrowDown");
