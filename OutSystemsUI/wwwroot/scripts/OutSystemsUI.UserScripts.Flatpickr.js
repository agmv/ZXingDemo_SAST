...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function FlatpickrInstance(element, instanceConfig) {
        ...
        /**
         * Method to create the focus trap elements and respective keydown events
         */
        function createFocusTrapElements() {
            // Create the focusable elements
            var _predictableTopElement = document.createElement("span");
            var _predictableBottomElement = document.createElement("span");
            // Set Classes
            _predictableTopElement.classList.add("focus-trap-top-element");
            _predictableBottomElement.classList.add("focus-trap-bottom-element");
            // Set Attributes
            _predictableTopElement.setAttribute("aria-hidden", "true");
            _predictableBottomElement.setAttribute("aria-hidden", "true");
            _predictableTopElement.setAttribute("tabindex", "0");
            _predictableBottomElement.setAttribute("tabindex", "0");
            // Set Focus event
            _predictableTopElement.addEventListener("keydown", function (e) {
                if (e.key === "Tab") {
                    if (e.shiftKey) {
                        //shift+tab pressed
                        _predictableBottomElement.focus();
                    }
                }
            });
            _predictableBottomElement.addEventListener("keydown", function (e) {
                if (e.key === "Tab") {
                    if (e.shiftKey) {
                        return;
                    }
            ...
            self.calendarContainer.prepend(_predictableTopElement);
            self.calendarContainer.append(_predictableBottomElement);
        }
            ...
            switch (e.key) {
                ...
                case "ArrowDown":
                    ...
                    if (self.config.noCalendar || self.isMobile) {
                        (_a = self.hourElement) === null || _a === void 0 ? void 0 : _a.focus();
                    }
        ...
        function onTimeKeydown(e) {
            ...
            if (document.activeElement === self.hourElement && e.key === "Tab") {
                if (e.shiftKey) {
                    e.preventDefault();
                    if (self.config.noCalendar || self.isMobile) {
                        (_a = self.altInput) === null || _a === void 0 ? void 0 : _a.focus();
                    }
                    else {
                        focusOnDay(getFirstAvailableDay(1), 0);
                    }
        ...
        function bindEvents() {
            ...
            bind(self._input, "keydown", onInputKeyDown);
            if (self.calendarContainer !== undefined) {
            ...
            if (self.daysContainer !== undefined) {
                ...
                bind(self.monthNav, "keydown", onMonthKeydown);
            ...
            if (self.timeContainer !== undefined &&
                ...
                bind(self.timeContainer, "keydown", onTimeKeydown);
                ...
                if (self.amPM !== undefined) {
                    ...
                    bind(self.amPM, "keydown", function (e) {
                        if (e.key === " ") {
                            updateTime(e);
                        }
                    });
        ...
        function build() {
            ...
            self.calendarContainer.setAttribute("aria-label", self.l10n.ariaLabelCalendar);
            ...
            if (!self.config.noCalendar) {
                ...
                if (self.config.weekNumbers) {
                    var _b = buildWeeks(), weekWrapper = _b.weekWrapper, weekNumbers = _b.weekNumbers;
        ...
        function createDay(className, date, _dayNumber, i) {
            ...
            if (self.weekNumbers &&
                ...
                i % 7 === 6) {
                self.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day' aria-hidden='true'>" + self.config.getWeek(date) + "</span>");
            }
        ...
        function buildTime() {
            ...
            if (!self.config.time_24hr) {
                ...
                self.amPM.setAttribute("aria-live", "polite");
        ...
        function documentClick(e) {
            if (self.isOpen && !self.config.inline) {
                ...
                var isInput = eventTarget_1 === self.input ||
                    ...
                    (e.composedPath() &&
                        e.composedPath().indexOf &&
                        (~e.composedPath().indexOf(self.input) ||
                            ~e.composedPath().indexOf(self.altInput)));
        ...
        function onBlur(e) {
            ...
            if (self.config.altInput) {
                var hiddenInputValue = self.element.getAttribute("value");
                valueChanged =
        ...
        function manageElementsTabindex() {
            var tabindexValue = self.isOpen || self.config.inline ? 0 : -1;
        ...
        function setupInputs() {
            ...
            if (self.config.altInput) {
                ...
                self.altInput.setAttribute("aria-haspopup", "true");
                self.altInput.setAttribute("aria-autocomplete", "none");
                self.altInput.setAttribute("aria-expanded", "false");
        ...
        function focusOnAvailableMonth() {
            ...
            var targetMonth = ((_a = self.calendarContainer) === null || _a === void 0 ? void 0 : _a.querySelector(".flatpickr-monthSelect-month.selected")) ||
                ((_b = self.calendarContainer) === null || _b === void 0 ? void 0 : _b.querySelector(".flatpickr-monthSelect-month:not(.flatpickr-disabled)"));
            // Focus on target month
            targetMonth === null || targetMonth === void 0 ? void 0 : targetMonth.focus();
        }
        /**
